...
def analyze_review(text: str = Form(...)):
    sentiment_prompt = f"What is the sentiment (Positive, Neutral, Negative) of the following review  in ONE WORD ONLY?\n\n{text}"
    topic_prompt = f"What is the main topic of this review in ONE WORD ONLY (e.g., delivery, quality, price)?\n\n{text}"
